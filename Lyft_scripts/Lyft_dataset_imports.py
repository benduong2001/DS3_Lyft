...
agents_table = agents_table.sort_values(["scene_index", "frame_index"]).reset_index(drop=True)
scenes_table = st_orig.copy()
scenes_table = scenes_table.sort_values(["scene_index"]).reset_index(drop=True)
